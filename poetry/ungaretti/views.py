...
import sys
#TODO
#sys.path.append('./ungaretti/python/')
import ungaretti.python.lite_call_runtime_top as call

States ={};

def UngarettiPageView(request):
    return HttpResponse('Hello, Strasly!')

	
class UngarettiInitView(APIView):
...
class UngarettiMessageView(APIView):
    permission_classes = (IsAuthenticated,)
...
class UngarettiRobustView(APIView):
    permission_classes = (IsAuthenticated,)
