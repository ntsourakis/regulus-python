...
def MontalePageView(request):
    return HttpResponse('Hello, Montale!')

	
class MontaleInitView(APIView):
...
class MontaleMessageView(APIView):
    permission_classes = (IsAuthenticated,)
...
class MontaleRobustView(APIView):
    permission_classes = (IsAuthenticated,)
