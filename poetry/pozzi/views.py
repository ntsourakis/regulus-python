...
import sys
#TODO
sys.path.append('./pozzi/python/')
import pozzi.python.lite_call_runtime_top as call

States ={};

def PozziPageView(request):
    return HttpResponse('Hello, Pozzi!')

	
class PozziInitView(APIView):
...
class PozziMessageView(APIView):
    permission_classes = (IsAuthenticated,)
