...
def QuasimodoPageView(request):
    return HttpResponse('Hello, Quasimodo!')

	
class QuasimodoInitView(APIView):
...
class QuasimodoMessageView(APIView):
    permission_classes = (IsAuthenticated,)
...
class QuasimodoRobustView(APIView):
    permission_classes = (IsAuthenticated,)
