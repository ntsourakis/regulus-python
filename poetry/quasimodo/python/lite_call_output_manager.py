...
import quasimodo.python.lite_call_english as english
import quasimodo.python.lite_call_french as french
import quasimodo.python.lite_call_german as german
